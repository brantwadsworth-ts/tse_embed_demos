...
// Acme AI question). Urgency banner + live countdown, a giant PAY NOW,
...
import { ACME_UPGRADE_URL } from '../config';
    ...
    <div className="sl-trial-overlay" onClick={onClose}>
      <div className="sl-trial-modal" onClick={(e) => e.stopPropagation()} role="dialog" aria-modal="true">
        ...
        <div className="sl-trial-body">
          ...
          <div className="sl-trial-eyebrow">A personal message from Acme AI</div>
          ...
          <a className="sl-trial-cta" href={ACME_UPGRADE_URL} target="_blank" rel="noopener noreferrer">
