// ---------------------------------------------------------------------------
// Central configuration for the Acme Analytics mockup.
// IDs + ThoughtSpot styling are sourced from acme_fin.json so that every
...
/**
 * Worksheet / model used everywhere Spotter runs — the "Acme AI" Spotter
 * modal (Analytics tab), the Ask Acme Spotter embed, and the host chatbot.
 */
export const WORKSHEET_ID = '06f92f41-00e5-4d81-8213-8a6616f83f49';

// ---------------------------------------------------------------------------
// ThoughtSpot embed styling — taken verbatim from
// acme_fin.json > stylingConfig.embeddedContent
// ---------------------------------------------------------------------------
 ...
 * Acme's green/coral accents. Passed per-embed for the active theme so the
 ...
 * cards, floating chrome), plus the KPI headline in the Acme green. Applied
...
/**
 * Welcome message for the host-owned Acme AI chatbot
 * (from acme_fin.json > appConfig.chatbot.welcomeMessage, lightly adapted).
 */
export const CHATBOT_WELCOME =
  "Hi! I'm Acme AI. Ask me about Acme, or ask a question about your data — like “show meetings booked by week” or “top cadences by influenced pipeline.”";
...
/** Spotter icon sprite (magician/spotter icon) from acme_fin.json. */
...
/**
 * String customizations — replace "Spotter" with "Acme AI" everywhere,
 * plus the landing-page description override (from
 * acme_fin.json > stylingConfig.embeddedContent.strings / stringIDs).
 */
...
// ---------------------------------------------------------------------------
// Embed flags — from acme_fin.json > stylingConfig.embedFlags
// ---------------------------------------------------------------------------
...
/** "Watch video" link shown in the Acme AI pane. */
export const ACME_VIDEO_URL = 'https://www.acme.com/platform/conversations';

/** Sample questions shown on the custom Acme AI landing pane. */
export const ACME_SAMPLE_QUESTIONS = [
...
/** Trial / upgrade prompt shown in the Acme AI pane after the 2nd query. */
export const ACME_TRIAL_QUESTIONS = 20;
export const ACME_UPGRADE_URL = 'https://www.acme.com/pricing';

/**
 * Hide the Spotter embed's own composer / input bar on the Acme AI screen
